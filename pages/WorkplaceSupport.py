...
GEMINI_API_KEY = "AIzaSyCW6X3nK9yF4Q-XNN-2nl3j3wYfoCv32zc"  # Replace with your API key
...
def main():
    ...
    # Main Title
    st.markdown('<p class="main-header">🧠 Neurodivergent Workplace Support</p>', unsafe_allow_html=True)
