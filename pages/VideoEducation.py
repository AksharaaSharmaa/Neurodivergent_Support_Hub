...
# Fetch and store service account JSON securely
service_account_json = access_secret("SERVICE_ACCOUNT_JSON")
with open("service-account-temp.json", "w") as f:
    f.write(service_account_json)

# Set up Google Cloud authentication
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "service-account-temp.json"
